(() => {
  ...
  const EN = {
    ...
    install1Body: "Download tellama-v1-3-8.apk from the public release. About 148 MB, including the offline semantic-search model.",
  ...
  const JA = {
    ...
    install1Body: "公開リリースから tellama-v1-3-8.apk をダウンロードします。オフライン意味検索モデルを含み、約148 MBです。",
  ...
  const ZH = {
    ...
    install1Body: "从公开发布页下载 tellama-v1-3-8.apk。包含离线语义搜索模型，大小约148 MB。",
