(() => {
  ...
  const EN = {
    ...
    install1Body: "Download tellama-v1-3-7.apk from the public release. About 148 MB, including the offline semantic-search model.",
    ...
    releasedAt: "Published September 16, 2026",
    downloadApk: "Download APK directly",
    releaseNotes: "Release notes",
    downloadQr: "Scan to open the latest download page",
    updateSlowNetwork: "If an update takes too long or restarts from zero, download the APK below in your browser and install it over the existing app. Do not uninstall Tellama. The existing updater cannot resume after Android stops a long-running job.",
  ...
  const JA = {
    ...
    install1Body: "公開リリースから tellama-v1-3-7.apk をダウンロードします。オフライン意味検索モデルを含み、約148 MBです。",
    ...
    currentRelease: "CURRENT RELEASE",
    releasedAt: "2026年9月16日公開",
    downloadApk: "APKを直接ダウンロード",
    releaseNotes: "リリースノート",
    downloadQr: "スキャンして最新ダウンロードページを開く",
    updateSlowNetwork: "更新に時間がかかる、または最初から繰り返す場合は、下のAPKをブラウザで取得し、既存アプリに上書きインストールしてください。Tellamaをアンインストールしないでください。従来の更新機能はAndroidによる長時間タスクの停止後に途中から再開できません。",
  ...
  const ZH = {
    ...
    install1Body: "从公开发布页下载 tellama-v1-3-7.apk。包含离线语义搜索模型，大小约148 MB。",
    ...
    currentRelease: "CURRENT RELEASE",
    releasedAt: "2026年9月16日发布",
    downloadApk: "直接下载 APK",
    releaseNotes: "发布说明",
    downloadQr: "扫码打开最新版本下载页",
    updateSlowNetwork: "如果更新耗时过长或从头重新下载，请用浏览器下载下方APK并覆盖安装。不要卸载Tellama。现有更新程序无法在Android停止长时间任务后断点续传。",
