(() => {
  ...
  const EN = {
    ...
    install1Body: "Download tellama-v1-3-5.apk from the public release.",
  ...
  const JA = {
    ...
    install1Body: "公開リリースから tellama-v1-3-5.apk をダウンロードします。",
  ...
  const ZH = {
    ...
    install1Body: "从公开发布页下载 tellama-v1-3-5.apk。",
