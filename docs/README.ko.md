...
**v1.3.7 Runtime 2.0:** CPU 실측 튜닝, 지원 Adreno 기기의 격리 GPU 가속, 오프라인 다국어 의미 기억을 제공합니다. 의미 검색 모델이 기본 포함되어 APK는 약 **148 MB**입니다. 대화용 GGUF 모델은 별도로 선택합니다. [릴리즈 노트](releases/v1.3.7.md).
