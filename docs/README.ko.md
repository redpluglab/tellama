...
**느린 업데이트 다운로드:** 기존 업데이트 기능은 Android가 장시간 다운로드를 종료하면 처음부터 다시 받을 수 있습니다(Android 16에서 30분 후 확인). 이 경우 공개 APK를 브라우저로 받아 기존 앱 위에 설치하세요. **앱을 삭제하지 않아야 데이터가 유지됩니다.** 다운로드 이어받기는 후속 수정에서 보완 중입니다.
